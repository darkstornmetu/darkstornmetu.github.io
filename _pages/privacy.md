...
This Service is provided by **Ahmet Buğra Çetinel** at no cost and is intended for use as is.  
...
- [Facebook Privacy Policy](https://facebook.com/about/privacy)
...
- [Voodoo Privacy Policy](https://www.voodoo.io/)
...
When you install and use **Ahmet Buğra Çetinel** mobile applications, we may collect and process some of your data for different **legitimate purposes**.  
Below are explanations regarding the reasons why we may collect data.

---

## Why is data collected?

**Ahmet Buğra Çetinel** and its third-party partners collect data:
...
The **third-party partners** that **Ahmet Buğra Çetinel** will share the data with are:
...
To **delete user data** collected by **Ahmet Buğra Çetinel**, please reach out to:  
📧 **[ahmetcetinel1992@gmail.com](mailto:ahmetcetinel1992@gmail.com)**

If you also want to request the deletion of the data that may have been collected about you or your device by our **third-party partners** acting as independent **data controllers**, below are the contacts and links to their privacy policies:

### GameAnalytics:
- Email: [privacy@gameanalytics.com](mailto:privacy@gameanalytics.com)
...
### Adjust:
- Email: [privacy@adjust.com](mailto:privacy@adjust.com)
- [Privacy Policy](https://www.adjust.com/terms/privacy-policy/)

### Voodoo:
- Email: [dpo@voodoo.io](mailto:dpo@voodoo.io)
